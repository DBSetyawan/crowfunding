...
<head>
    ...
    <title>Edit Profile -  Kotakamal</title>
...
<main class="content">
    ...
    <div class="row card-container" >
        ...
        <form class="standard-form col-md-12" method="POST" action="{{route('profile.edit_post')}}">
            {{ csrf_field() }}
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" placeholder="Nama" name="nama"  value="{{$user->name}}">
                @error('nama')
                    <small class="form-text text-danger">{{ $message }}</small>
                @enderror
            </div>
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" placeholder="No. HP" name="no_hp"  value="{{$user->no_whatsapp}}">
                @error('no_hp')
                    <small class="form-text text-danger">{{ $message }}</small>
                @enderror
            </div>
