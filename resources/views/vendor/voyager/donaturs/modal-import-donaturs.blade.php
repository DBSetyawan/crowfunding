...
<div class="modal fade modal-confirmation" id="modal-print-last-month" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
    ...
    <div class="modal-content">
        ...
        <h4 class="modal-title" id="myModalLabel">Import data donaturs</h4>
        </div>
        <div class="modal-body" >
            <div class="container mt-5 text-center">
                <form action="{{ route('file-import-donaturs') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    ...
                    <button class="btn btn-primary">Import donaturs</button>
                </form>
            </div>
        </div>
