...
<div class="modal fade modal-confirmation" id="modal-transaction-import-hisotry" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
    ...
    <div class="modal-content">
        ...
        <h4 class="modal-title" id="myModalLabel">Import data Transaction history</h4>
        </div>
        <div class="modal-body" >
            <div class="container mt-5 text-center">
                <form action="{{ route('file-import-history') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    ...
                    <button class="btn btn-primary">Import History</button>
                </form>
            </div>
        </div>
