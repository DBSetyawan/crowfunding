...
Route::group(['prefix' => 'admin'], function () {
    ...
    Route::get('donaturs/update-payment/{donatur_id}','Voyager\DonaturController@listHistoryGroupDonatur')->name('donaturs.update.transaction');
    Route::get('donaturs/print/group/donatur/{group_name}','Voyager\DonaturController@printgroupnames')->name('donaturs.print.donatur.groups');
