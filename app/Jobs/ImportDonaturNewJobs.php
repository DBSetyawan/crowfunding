...
use App\Imports\ImportDonaturNew;
...
class ImportDonaturNewJobs implements ShouldQueue
{
    ...
    {   
        ...
        (new ImportDonaturNew)->queue(storage_path('app/public/temp/' . $this->filename));
