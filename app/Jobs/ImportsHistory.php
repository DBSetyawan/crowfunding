...
class ImportsHistory implements ShouldQueue
{
    ...
    public function handle()
    {
        ...
        Excel::import(new UserAutomaticallyInsert, storage_path('app/public/temp/' . $this->filename)); //MENJALANKAN PROSES IMPORT
